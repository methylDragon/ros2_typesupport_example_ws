...
{
  new (message_memory) ts_example_msgs::msg::Example(_init);
}

void Example_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ts_example_msgs::msg::Example *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Example_message_member_array[2] = {
  {
    ...
    offsetof(ts_example_msgs::msg::Example, example_member_aaa),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ts_example_msgs::msg::Example, example_member_bbb),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Example_message_members = {
  ...
  2,  // number of fields
  sizeof(ts_example_msgs::msg::Example),
...
get_message_type_support_handle<ts_example_msgs::msg::Example>()
{
  return &::ts_example_msgs::msg::rosidl_typesupport_introspection_cpp::Example_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ts_example_msgs, msg, Example)() {
  return &::ts_example_msgs::msg::rosidl_typesupport_introspection_cpp::Example_message_type_support_handle;
}
