...
#include "ts_example_msgs/msg/detail/example__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ts_example_msgs::msg::Example *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ts_example_msgs::msg::Example *>(
    untyped_ros_message);
...
{
  return &ts_example_msgs::msg::typesupport_fastrtps_cpp::_Example__handle;
}
