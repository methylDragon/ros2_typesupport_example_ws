...
#include "ts_example_msgs/msg/detail/example__rosidl_typesupport_fastrtps_c.h"
...
using _Example__ros_msg_type = ts_example_msgs__msg__Example;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: example_member_aaa
  {
    cdr << (ros_message->example_member_aaa ? true : false);
  }

  // Field name: example_member_bbb
  {
    cdr << ros_message->example_member_bbb;
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: example_member_aaa
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->example_member_aaa = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name example_member_aaa
  {
    size_t item_size = sizeof(ros_message->example_member_aaa);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name example_member_bbb
  {
    size_t item_size = sizeof(ros_message->example_member_bbb);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Example__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ts_example_msgs__msg__Example(
...
static size_t _Example__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ts_example_msgs__msg__Example(
